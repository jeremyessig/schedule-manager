...
#	var normal_texture := create_button_texture("btn_32x32_03.png") ## Bug on Windows !
	var normal_texture := load("res://addons/calendar_button/btn_img/btn_32x32_03.png")
	set_normal_texture(normal_texture)

#	var pressed_texture := create_button_texture("btn_32x32_04.png")
	var pressed_texture := load("res://addons/calendar_button/btn_img/btn_32x32_04.png") 
	set_pressed_texture(pressed_texture)

func create_button_texture(var image_name : String) -> ImageTexture: ## Bug on Windows !
